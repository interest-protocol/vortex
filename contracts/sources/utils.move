...
public(package) fun vector_u256_to_bytes(value: vector<u256>): vector<u8> {
    bcs::to_bytes(&(value))
}

public(package) fun address_to_field(address: address): u256 {
    u256_to_field(address.to_u256())
}

public(package) fun u256_to_field(value: u256): u256 {
